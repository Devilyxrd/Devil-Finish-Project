    ...
    <div class="anakutu">
        ...
        <div class="reg-box">
            ...
            <form action="register.php" method="post" class="reg-form" autocomplete="off">
                ...
                <input type="submit" value="Kayıt Ol" id="reg-btn" name="kayitol">
                <!--INPUTS-->
            </form>

            <p id="giris">Hey Dev Akademiye Hoşgeldin! Mevcut bir hesabın mı var bu harika! <a href="#">Buradan giriş sayfasına gidebilirsin</a></p>
        </div>
    </div>
        ...
        if( empty($ad) && empty($soyad) && empty($email) && empty($sifre) && empty($sifretekrar)  ){
          ...
          if(filter_var($email,FILTER_VALIDATE_EMAIL) == false){
            ...
            $insert = $db->prepare("INSERT INTO devilmembers SET
              ...
              email=?,
              sifre=?");
              $insert->execute([$ad,$soyad,$email,$sifre]);
